...
class CreateImageForm(forms.SelfHandlingForm):
    ...
    copy_from = forms.CharField(max_length="255",
                                ...
                                help_text=_("An external (HTTP, S3, or Swift)"
                                    " URL where the image should be loaded"
                                    " from."),
                                required=True)
    ...
    minimum_disk = forms.IntegerField(label=_("Minimum Disk (GB)"),
                                    help_text=_('The minimum disk size'
                                            ...
                                            ' image. If unspecified, this value'
    ...
    def handle(self, request, data):
        ...
        try:
            ...
            messages.success(request, _('Image was successfully created.'))
        except:
