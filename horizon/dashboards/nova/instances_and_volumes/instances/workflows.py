...
class SelectInstanceBaseAction(workflows.Action):
    ...
    class Meta:
        ...
        help_text_template = ("nova/instances_and_volumes/instances/"
                              "_launch_source_help.html")

    def clean(self):
        cleaned_data = super(SelectInstanceBaseAction, self).clean()
...
class SelectInstanceBase(workflows.Step):
    ...
    contributes = ("source_type",
                   ...
                   "delete_on_terminate")
    connections = {"project_id": ("self.update_images",)}

    def update_images(self, request, context):
        filters = {"property-owner_id": context['project_id']}
        return api.glance.image_list_detailed(request, filters=filters)

    def contribute(self, data, context):
        context = super(SelectInstanceBase, self).contribute(data, context)
...
class CustomizeAction(workflows.Action):
    ...
    class Meta:
        ...
        help_text = _("You can customize your instance after it's launched "
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            messages.success(request,
                             _('Instance "%s" launched.') % context["name"])
            return True
        except:
            exceptions.handle(request,
