...
setup(name="horizon",
      ...
      url='https://github.com/gabrielhurley/horizon/',
      license='Apache 2.0',
      description="An extensible framework for building dashboards in Django.",
      long_description=read('README.rst'),
      author='Gabriel Hurley, forked from OpenStack',
